...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            "dlc-cssterminal": LocalJSX.DlcCssterminal & JSXBase.HTMLAttributes<HTMLDlcCssterminalElement>;
            "dlc-cssterminal-block": LocalJSX.DlcCssterminalBlock & JSXBase.HTMLAttributes<HTMLDlcCssterminalBlockElement>;
        }
    }
}
